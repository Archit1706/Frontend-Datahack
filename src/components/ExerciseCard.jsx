  ...
  return (
    <div className="flex flex-col w-full m-4 p-4 md:max-w-[640px] bg-gray-200 shadow-md rounde-md gap-4">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 justify-center mx-auto items-center text-center py-4 px-8 gap-4">
        ...
        <div className="flex flex-col justify-center rounded-full bg-orange-500 aspect-square w-64 p-2 mx-4 border-8 shadow-md border-white border-solid">
          {exercise.sets!=0?<><div>
      ...
      <div className="rounded-lg p-4 bg-orange-500">
