            ...
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto justify-center items-center">
              <li>
                <div className="flex items-center">
                  <Link to='/dashboard'>
                    <button
                      className="bg-inherit text-gray-700 hover:text-white hover:bg-[#c759ff] text-sm font-bold uppercase px-4 py-2 rounded hover:shadow-lg outline-none focus:outline-none lg:mr-1 lg:mb-0 md:ml-3 md:mb-3 ease-linear transition-all duration-150"
                    >
                      Dashboard
                    </button>
                  </Link>
