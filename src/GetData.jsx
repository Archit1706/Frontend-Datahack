...
export default function GetData(props) {
  ...
  useEffect(() => {
    ...
    async function fetchData() {
      ...
      let updatedAt = ''
      //1
      let res = await fetch("https://Backend.sidd065.repl.co/api/users/find", {
        method: "POST",
        headers: {
      ...
      //2
      props.update(1)
      res = await fetch("https://Backend.sidd065.repl.co/api/info/getCalories", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      props.update(1)
      res = await fetch("https://Backend.sidd065.repl.co/api/info/getSteps", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      props.update(1)
      res = await fetch("https://Backend.sidd065.repl.co/api/meals/getdetails", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      props.update(1)
      res = await fetch("https://Backend.sidd065.repl.co/api/meals/weeklyCals", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      res = await fetch("https://Backend.sidd065.repl.co/api/friend/search", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
      ...
      props.update(1)
      //9
      res = await fetch("https://Backend.sidd065.repl.co/api/users/all", {
        method: "POST",
        headers: {
          'Content-Type': 'application/json'
        },
