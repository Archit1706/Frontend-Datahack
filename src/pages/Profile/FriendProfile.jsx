...
body: JSON.stringify({
  ...
  // steps
  const data1 = {
    labels: [`${localStorage.getItem("friendname")} - Steps`, `${localStorage.getItem("name")} - Steps`],
    datasets: [
      {
        label: "Steps Covered",
        data: [
  ...
  // weight
  const data2 = {
    labels: [`${localStorage.getItem("friendname")} - Calories Burnt`, `${localStorage.getItem("name")} - Calories Burnt`],
    datasets: [
      {
