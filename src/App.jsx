  ...
  return (
    <Router>
      <Routes>
        ...
        <Route exact path="/tnc" element={<div>
        ...
        <Route exact path="/chat/injury" element={<div>
        ...
        <Route exact path="/exercise" element={<div>
        ...
        <Route exact path="/exercise/pick-a-workout" element={<div>
        ...
        <Route exact path="/m/exercise/pick-a-workout" element={<div>
        ...
        <Route exact path="/exercise/chest-abs-back" element={<div>
        ...
        <Route exact path="/exercise/legs-triceps-calves" element={<div>
        ...
        <Route exact path="/exercise/shoulders-biceps-forearms" element={<div>
        ...
        <Route exact path="/exercise/cardio" element={<div>
        ...
        <Route exact path="/exercise/stretching" element={<div>
        ...
        <Route exact path="/leaderboard" element={<div>
        ...
        <Route exact path="/events" element={<div>
        ...
        <Route exact path="/workout" element={<div>
